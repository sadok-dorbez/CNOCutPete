...
public class ListMessageForm extends BaseForm{
     ...
     Form current ;
    public ListMessageForm (Resources res ) {
        ...
        RadioButton mesListes = RadioButton.createToggle(" les Messages ", barGroup);
        ...
        ArrayList<Forum>list = ServiceForum.getInstance().affichageMessages();
        ...
        for (Forum rec : list ) {
           ...
           URLImage urlim = URLImage.createToStorage(enc, urlImage, urlImage, URLImage.RESIZE_SCALE);
            ...
            addButton(urlim,rec.getTitre(),rec.getContenu(), rec);
    ...
    private void addButton(Image img ,String titre, String contenu ,Forum rec) {
