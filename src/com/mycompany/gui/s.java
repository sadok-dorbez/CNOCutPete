 ...
 * @author ziedm
 */
public class s extends BaseForm{
    ...
    public s (Resources res ) {
        ...
        RadioButton partage = RadioButton.createToggle(" SATictis ", barGroup);
        ...
        //  ListReclamationForm a = new ListReclamationForm(res);
          //  a.show();
           ...
           GridLayout.encloseIn(5, mesListes,mesListesForum,mesListesReclamation,mesListesParticipationsPrive, partage),
        ...
        bindButtonSelection(mesListesForum, arrow);
        bindButtonSelection(mesListesReclamation, arrow);
         bindButtonSelection(mesListesParticipationsPrive, arrow);
