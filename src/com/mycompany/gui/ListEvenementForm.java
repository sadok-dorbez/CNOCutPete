...
public class ListEvenementForm extends BaseForm {
  ...
  Form current ;
    public ListEvenementForm (Resources res ) {
        ...
        ArrayList<Evenement>list = ServiceEvenement.getInstance().affichageEvenements();
    ...
    private void addButton(Image img ,Evenement rec , Resources res) {
        ...
        Label typeETxt = new Label("typeE : "+rec.getTypeE(), "NewsTopLine2");
        ...
        Label imageTxt = new Label("image : "+rec.getImage(), "NewsTopLine2");
         Label date_debutTxt = new Label("date_debut : "+rec.getDate_debut(), "NewsTopLine2"   );
        Label date_finTxt = new Label("date_fin : "+rec.getDate_fin(), "NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")) {
                ...
                if(ServiceEvenement.getInstance().deleteEvenement(rec.getId())) {
                    new ListEvenementForm(res).show();
                }
       ...
       cnt.add(BorderLayout.CENTER , BoxLayout.encloseY(
        ...
        BoxLayout.encloseX(typeETxt),
        BoxLayout.encloseX(descriptionTxt),
        BoxLayout.encloseX(imageTxt),
        BoxLayout.encloseX(date_debutTxt),
        BoxLayout.encloseX(date_finTxt)));
