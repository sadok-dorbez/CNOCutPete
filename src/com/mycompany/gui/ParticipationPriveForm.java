 ...
 * @author ziedm
 */
public class ParticipationPriveForm extends BaseForm {
    
    
       Form current;
    public ParticipationPriveForm(Resources res){
        ...
        setTitle("Ajouter participation prive ");
        ...
        RadioButton partage = RadioButton.createToggle(" participer ", barGroup);
        ...
        TextField numeroTel =  new TextField("","Saisir Votre numeroTel");
        numeroTel.setUIID("TextFieldBlack");
        addStringValue("numeroTel",numeroTel);
        
        TextField nbrPrisecharge =  new TextField("","Saisir Votre nbrPrisecharge");
        nbrPrisecharge.setUIID("TextFieldBlack");
        addStringValue("nbrPrisecharge",nbrPrisecharge);
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                if( numeroTel.getText().equals("")|| nbrPrisecharge.getText().equals("")){
                    ...
                    ParticipationPrive r = new ParticipationPrive(
                     String.valueOf(numeroTel.getText()).toString(),
                               String.valueOf(nbrPrisecharge.getText()).toString(),
                    SessionManager.getId());
                    
                     
                    
                    System.out.println("data  participationprive == "+r);
                    
                    
                      //appelle methode ajouterReclamation mt3 service Reclamation bch nzido données ta3na fi base
                        ServiceParticipationPrive .getInstance().ajouterParticipationPrive(r);
