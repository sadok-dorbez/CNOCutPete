 ...
 * @author ziedm
 */
public class ParticipationPublicForm extends BaseForm {
     
     Form current;
    public ParticipationPublicForm(Resources res){
        ...
        setTitle("Ajouter participation public ");
        ...
        TextField donation =  new TextField("","Saisir Votre Donation");
        donation.setUIID("TextFieldBlack");
        addStringValue("Donation",donation);
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                if( donation.getText().equals("")){
                    ...
                    ParticipationPublic r = new ParticipationPublic(
                     String.valueOf(donation.getText()).toString(),
                      SessionManager.getId());
                    
                    System.out.println("data  participationpublic == "+r);
                    
                    
                      //appelle methode ajouterReclamation mt3 service Reclamation bch nzido données ta3na fi base
                        ServiceParticipationPublic.getInstance().ajouterParticipationPublic(r);
