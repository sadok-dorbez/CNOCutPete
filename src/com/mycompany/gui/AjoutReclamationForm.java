...
public class AjoutReclamationForm extends BaseForm {
    ...
    public AjoutReclamationForm(Resources res){
        ...
        TextField titre =  new TextField("","Entrer titre de reclamation");
        titre.setUIID("TextFieldBlack");
        addStringValue("titre",titre);
        
           
        TextField contenu =  new TextField("","Entrer contenu de reclamation");
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                if(titre.getText().equals("") || contenu.getText().equals("")){
                    ...
                    Reclamation r = new Reclamation(String.valueOf(titre.getText()
                              ).toString(),
           ...
           Container ct = new Container(BoxLayout.y());
            ...
            pdf.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    ...
                    if (Dialog.show("Confirmation", "Voulez vous imprimer cette reclamation  en pdf ?", "Oui", "Annuler")) {
